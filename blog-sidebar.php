...
<head>
    ...
    <title>Blog Sidebar || Greenin - Environment & Non-Profit HTML5 Template</title>
...
<body>
    ...
    <div class="wrapper">
                        ...
                        <div class="menumenu__container clearfix">
                            <div class="col-md-9 hidden-sm hidden-xs">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        <li class="drop"><a href="index.php"><img src="images/icons/menu.png" alt="icon image"></a>
                                            <ul class="dropdown">
        ...
        <div class="ht__bradcaump__area" data--black__overlay="6" style="background: rgba(0, 0, 0, 0) url(images/bg/2.jpg) no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Blog Sidebar</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                        <div class="blog__sidebar__left">
                            ...
                            <div class="ht__blog__list">
                                ...
                                <div class="ht__blog__dtl__inner">
                                    <div class="ht__blog__dtl">
                                        <h2><a href="blog-details.php">There are many variations of this Lorem</a></h2>
                                        <ul class="bl__meta">
                            ...
                            <!-- End Single SideBar -->
                            <!-- Start Single SideBar -->
                            <div class="ht__blog__list mt--50">
                                <div class="ht__blog__thumb">
                                    <iframe src="https://www.youtube.com/embed/e5UTaPV-DIg" allowfullscreen></iframe>
                                </div>
                                <div class="ht__blog__dtl__inner">
                                    <div class="ht__blog__dtl">
                                        <h2><a href="blog-details.php">There are many variations of this Lorem</a></h2>
                                ...
                                <div class="lst__blog__inner">
                                    <div class="single__lst__blog">
                                        <div class="lst__bl__thumb">
                                            <a href="blog-details.php">
                                                <img src="images/blog/sm-img-2/1.jpg" alt="blog image">
                                            </a>
                                        </div>
                                        <div class="lst__bl__details">
                                            <h4><a href="blog-details.php">How to make your garden cleane</a></h4>
                                    ...
                                    <div class="single__lst__blog">
                                        <div class="lst__bl__thumb">
                                            <a href="blog-details.php">
                                                <img src="images/blog/sm-img-2/2.jpg" alt="blog image">
                                            </a>
                                        </div>
                                        <div class="lst__bl__details">
                                            <h4><a href="blog-details.php">How to make your garden cleane</a></h4>
                                    ...
                                    <div class="single__lst__blog">
                                        <div class="lst__bl__thumb">
                                            <a href="blog-details.php">
                                                <img src="images/blog/sm-img-2/3.jpg" alt="blog image">
                                            </a>
                                        </div>
                                        <div class="lst__bl__details">
                                            <h4><a href="blog-details.php">How to make your garden cleane</a></h4>
                                    ...
                                    <div class="single__lst__blog">
                                        <div class="lst__bl__thumb">
                                            <a href="blog-details.php">
                                                <img src="images/blog/sm-img-2/4.jpg" alt="blog image">
                                            </a>
                                        </div>
                                        <div class="lst__bl__details">
                                            <h4><a href="blog-details.php">How to make your garden cleane</a></h4>
